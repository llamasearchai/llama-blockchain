...
try:
    ...
    print(
        "Warning: web3.py is not installed. Ethereum connectivity features will not work."
    )
    print(
        "To enable full functionality, install with: pip install llama_blockchain[ethereum]"
    )
