...
class DAOManager:
    ...
    def delegate(
        self, governance_token: str, delegate_address: str, **kwargs
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if block_number:
                ...
                result = self.contract_validator.call_function(
                    governance_token,
                    "getVotes",
                    account,  # Positional  # Positional  # Positional
                )
    ...
    def get_proposal(self, dao_contract: str, proposal_id: int) -> Dict[str, Any]:
        ...
        try:
            ...
            state_result = self.contract_validator.call_function(
                dao_contract,
                "state",
                proposal_id,  # Positional  # Positional  # Positional
            )
    ...
    def cancel_proposal(
        self, dao_contract: str, proposal_id: int, **kwargs
    ) -> Dict[str, Any]:
        """
